 ...
 * classificadas de acordo com o tempo de serviço.
 *
 * Crie a classe Vendedor com as seguintes especificações
 *
 * Atributos:
 *    nome
 *    salarioBase (inicialmente R$ 2.000,00)
 *    tempoServico (em meses)
 *    categoria (A, B ou C, conforme as regras:
 *      A se tempo de serviço > 60 meses,
 *      B entre 30 e 60 meses inclusive,
 *      C se menor que 30 meses)
...
public class Vendedor {
    ...
    private static double salarioBase = 2000; // METODO ESTATICO DA CLASSE
